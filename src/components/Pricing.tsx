  ...
  return (
    <section className="py-16 md:py-24 bg-black">
      <div className="px-4 md:px-6 max-w-7xl w-full mx-auto">
          ...
          <div className="flex items-center justify-center gap-4 mb-12">
            <span
              className={`text-base transition-colors ${
                !isYearly ? "text-[#EAECE5]" : "text-[#EAECE5]/60"
              }`}
            >
              Monthly
            </span>
        ...
        {/* Pricing Cards */}
        <div className="flex items-stretch gap-6 md:gap-8 max-w-[1200px] w-full flex-col lg:flex-row mx-auto">
          {/* Starter Plan */}
          <div className="flex flex-col gap-8 md:gap-12 p-6 md:p-8 lg:p-11 rounded-3xl border border-white/10 bg-white/[0.04] w-full max-w-[389px] mx-auto lg:mx-0">
